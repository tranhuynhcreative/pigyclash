...
## 1. Your Consent
By downloading, installing, and using **Pigy Clash**, you acknowledge that you have read, understood, and agree to the entire contents of this Policy. We will display a consent notice when you first launch the game.
...
*   **Unity Technologies:**
    *   **Unity Ads & Analytics:** Collects data to provide advertising and analyze user behavior.
    *   **Unity Cloud Save:** Stores your game progress in the cloud.
    *   **Unity IAP:** Processes in-app purchases.

*   **Google:**
    *   **Google Analytics for Firebase:** Helps us analyze user behavior to improve the game.
    *   **Google AdMob:** Provides advertising within the game.
    *   **Google Play Game Services:** Provides social features such as leaderboards, achievements, and cloud storage.
